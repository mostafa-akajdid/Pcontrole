      ...
      if (project) {
        setForm({
          ...
          categories: Array.isArray(project.categories)
            ? project.categories.map((c) => (typeof c === 'string' ? c : c.id))
            : [],
        ...
        if (project.slug) setSlugManuallyEdited(true);
      } else {
        ...
        <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between z-10">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {isEditMode ? 'Update project information' : 'Fill in the details to create a project'}
            </p>
          </div>
          <button
            onClick={handleClose}
                    ...
                    <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800/50">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-green-700 dark:text-green-500 text-xs truncate">
                          https://yoursite.com/{form.slug || 'project-slug'}
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 text-sm line-clamp-2">
                          {form.metaDescription || form.shortDescription || 'No description provided.'}
                        </p>
                      </div>
                    </div>
                  )}
